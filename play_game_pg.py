from policy_gradient import Agent, Policy, action_selection
import pygame
import random
...
class SnakeGame:
    ...
    def getFeature(self):
        ...
        return np.array([threat_up, threat_right, threat_down, threat_left, Is_food_up, Is_food_right, Is_food_down, Is_food_left], np.float32)
    ...
    def play_step(self):
        ...
        action = action_selection(policy=Mymodel, observation=observation)
